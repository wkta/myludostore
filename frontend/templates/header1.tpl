...
<div class="wrapper" style="padding-top:30px; margin-bottom:35px;">
	...
	<div id="login-header">
		...
		<h3>Welcome {$my_username}!</h3>
			
		<div class="login-container"><div style="margin-bottom:8px; font-weight: bold; color:white; font-size:2.1em;">
		Balance= {$gp_balance} GP
		</div>
			
		<a href="{$history_url}" target="_blank">
		Game history
		</a>
		&nbsp;&nbsp;&nbsp;
